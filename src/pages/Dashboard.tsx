...
const lifecycleData = [
  { name: "新患者", value: 1240, color: "var(--medical-button)" },
  { name: "复诊患者", value: 3820, color: "var(--medical-blue-600)" },
...
const aiSuggestions = [
  {
    type: "warning",
    icon: "⚠️",
    text: "发现 127 名慢病患者本月依从性下降，建议立即触发随访干预",
    action: "立即处理",
  },
  {
    type: "opportunity",
    icon: "🎯",
    text: "312 名出院患者进入复诊黄金期（第 7-14 天），推荐发送复诊提醒",
    action: "创建任务",
  },
  {
    type: "insight",
    icon: "💡",
    text: "周四 10:00-11:00 为本周最佳推送时间，打开率高出均值 34%",
    action: "查看详情",
  },
  {
    type: "risk",
    icon: "🔴",
    text: "48 名高血压患者超过 90 天未复诊，失访风险极高",
    action: "预警干预",
  },
];
  ...
  return (
    <div className="p-6 space-y-6 fade-in">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                  {item.trend === "up" && (
                    <ArrowUp size={11} style={{ color: item.color }} />
                  )}
        ...
        <div className="col-span-2 glass-card p-5">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={trendData}>
              <defs>
                {[
                  ["indigo", "var(--medical-button)"],
                  ["cyan", "var(--medical-blue-600)"],
                  ["emerald", "#059669"],
                ].map(([n, c]) => (
                  <linearGradient
                    key={n}
              ...
              <XAxis
                dataKey="day"
                tick={{ fill: "var(--medical-text-muted)", fontSize: 11 }}
                axisLine={false}
                tickLine={false}
              />
              <YAxis
        ...
        <div className="glass-card p-5">
          ...
          <ResponsiveContainer width="100%" height={140}>
            <PieChart>
              ...
              <Tooltip
                formatter={(v: any) => [v.toLocaleString(), "患者数"]}
                contentStyle={{
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-2 glass-card p-5">
          <div className="section-header">
            <Brain size={16} style={{ color: "var(--medical-blue-600)" }} />
          ...
          <div className="space-y-3">
            {aiSuggestions.map((s, i) => (
              <div
                ...
                style={{ border: "1px solid var(--medical-border)" }}
              >
              ...
              {deptData.map((d, i) => (
                <div key={d.dept} className="flex items-center gap-2">
                  <span
                    ...
                    style={{
                      color: i < 3 ? "#d97706" : "var(--medical-text-muted)",
                    }}
                  >
                    {i + 1}
                  </span>
